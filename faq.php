    ...
    <div class="accordion" id="accordionExample">
      ...
      <div class="accordion-item">
        ...
        <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
          <div class="accordion-body">
            <strong>A:Unfortunately....we just a website about information ,not sell tour.Maybe,in future,we wiil add
              it!</strong>
          </div>
        </div>
      </div>
      <div class="accordion-item">
        ...
        <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
          <div class="accordion-body">
            <strong>A:Sorry for hear that.Please contact us by follow the mail and phone in <a
                href="contact.php">Contact Us</a></strong>
          </div>
        </div>
      </div>
      <div class="accordion-item">
