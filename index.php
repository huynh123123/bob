...
<div class="container-fluid">
  <div id="carousel-example-generic" class="carousel slide position-relative" data-bs-ride="carousel">
    <div class="carousel-inner">
      ...
      <button class="carousel-control-next" data-bs-target="#carousel-example-generic" type="button"
        data-bs-slide="next">
  ...
  <div class="container text-center">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-10 mb-6">
          ...
          if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
              ...
              echo '<div class="row-md-1">';
              echo '<div class="col-lg-3 col-md-5 col-sm-6 py-3">';
    ...
    <div class="card mb-3" style="max-width: 100%;">
      <div class="row g-3">
        <div class="col-md-5">
          <iframe width="500" height="320" src="https://www.youtube.com/embed/RvZFYE5jo1M?si=HBBwit7t-s4v1jFd"
        ...
        <div class="col-md-7">
          <div class="card-body">
            <h5 class="card-title">Tropical Island Walk | Ocean Beach Nature | Motu Tane | Bora Bora, French Polynesia
            </h5>
            <p class="card-text">The Tropical Island Walk on Motu Tane, Bora Bora, in French Polynesia offers a
              breathtaking experience of the ocean beach nature in one of the world's most idyllic locations. Motu Tane
              is a private island located near the main island of Bora Bora, known for its pristine white sandy beaches,
              crystal-clear turquoise waters, and lush tropical vegetation.</p>
            <p class="card-text">As you embark on the Tropical Island Walk, you'll find yourself surrounded by the
              stunning beauty of nature. The walk takes you along the shoreline, allowing you to soak in the panoramic
              views of the sparkling ocean and the distant mountains of Bora Bora. The gentle sounds of waves crashing
              against the shore create a soothing ambiance, making it a perfect escape from the hustle and bustle of
              daily life.</p>
          </div>
        </div>
      </div>
